...
var customScripts = {
	...
	waySlide: function(){
		   ...
		   ------------------------------------------------------ */		   			  			
			...
			$('#aboutMe').addClass( 'animated fadeInUp show' );   
			}, { offset: 800}); 
			$('#contactMe').waypoint(function() {				
			$('#contactMe .parlex-back').addClass( 'animated fadeInUp show' );   
			}, { offset: 800}); 
...
$('document').ready(function () {
    ...
    customScripts.init();
	$('#services .col-md-3, #features, #aboutMe, #clients, #portfolio, #plans, #contactMe .parlex-back').css('opacity','0');
